...
// data processing done here , satrs counting or language counting
...
function renderUI(data, processed) {
  ...
  if (sortedLanguages.length === 0) {
    ...
    const totalReposWithLang = Object.values(processed.sortedLanguages).reduce(
